...
# Subscribe to topic
consumer.subscribe([humidity_topic])

print(f"Subscribed to topics '{humidity_topic}'")

# Processing messages from topic
try:
  for message in consumer:
    print(f"HUMIDITY ALERT - Recieved message: {message.value}, with key: {message.key}, partition: {message.partition} ")
